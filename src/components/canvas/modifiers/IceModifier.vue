...
import type { Theme, IceModifier } from '@/types.d';
import { TileType } from '@/types.d';
import { computed } from 'vue';

const props = defineProps<{
  modifier: IceModifier
  theme: Theme
}>()

const color = computed(() => props.modifier.tile.type === TileType.DOT
  ? props.theme.colorMap.dots[props.modifier.tile.color]
  : 'rgba(255,255,255,.5)'
)
</script>
